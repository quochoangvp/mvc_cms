<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <p class="text-center" id="message-ajax">Hãy kéo thả các trang đến vị trí mong muốn và bấm "Lưu"</p>
...
<script type="text/javascript">
    $(document).ready(function() {
        $.post('<?php echo ADM_URL.'page/order_ajax'; ?>', { }, function(data, textStatus, xhr) {
            $('#show-list').html(data);
        });
        ...
        $('#save').click(function(event) {
            ...
            $.post('<?php echo ADM_URL.'page/order_ajax'; ?>', { pages : data }, function(data, textStatus, xhr) {
                $('#save').button('reset');
                $('#show-list').html(data);
